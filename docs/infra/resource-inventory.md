...
| `ApiFunctionCE271BD4` | `AWS::Lambda::Function` | Lambda function | `{"handler":"handler.handler","runtime":"nodejs22.x","architectures":["arm64"],"memorySize":256,"timeoutSeconds":10,"loggingConfig":{"LogFormat":"JSON","LogGroup":{"Ref":"ApplicationLambdaLogGroup59F70C75"}},"environment":{"Variables":{"GAME_TABLE_NAME":{"Ref":"GameTable0C79FC62"},"CONNECTION_TABLE_NAME":{"Ref":"ConnectionTable0C6E1E44"},"WEBSOCKET_URL":"/ws/v1","WEBSOCKET_MANAGEMENT_ENDPOINT":{"Fn::Join":["",["https://",{"Fn::Select":[2,{"Fn::Split":["/",{"Fn::Join":["",["wss://",{"Ref":"WebSocketApi34BCF99B"},".execute-api.",{"Ref":"AWS::Region"},".",{"Ref":"AWS::URLSuffix"},"/v1"]]}]}]},"/v1"]]}}}}` |
...
| `SiteDeploymentCustomResource42D55606` | `Custom::CDKBucketDeployment` | CloudFormation resource | `{"ServiceToken":"<masked-or-reference>","SourceBucketNames":[{"Fn::Sub":"cdk-hnb659fds-assets-${AWS::AccountId}-${AWS::Region}"}],"SourceObjectKeys":["ceba59d3e631e96b095c6104543ba45e5b10a78d1174be2da23450cad45eccdc.zip"],"DestinationBucketName":{"Ref":"SiteBucket397A1860"},"WaitForDistributionInvalidation":true,"Prune":true,"DistributionId":{"Ref":"Distribution830FAC52"},"DistributionPaths":["/*"],"OutputObjectKeys":true}` |
