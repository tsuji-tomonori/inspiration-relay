...
| `SiteDeploymentCustomResource42D55606` | `Custom::CDKBucketDeployment` | CloudFormation resource | `{"ServiceToken":"<masked-or-reference>","SourceBucketNames":[{"Fn::Sub":"cdk-hnb659fds-assets-${AWS::AccountId}-${AWS::Region}"}],"SourceObjectKeys":["91865a783b5f10fd226764618021be843a7f7e7cea5a265333c32c35bff2ceee.zip"],"DestinationBucketName":{"Ref":"SiteBucket397A1860"},"WaitForDistributionInvalidation":true,"Prune":true,"DistributionId":{"Ref":"Distribution830FAC52"},"DistributionPaths":["/*"],"OutputObjectKeys":true}` |
