...
| `SiteDeploymentCustomResource42D55606` | `Custom::CDKBucketDeployment` | CloudFormation resource | `{"ServiceToken":"<masked-or-reference>","SourceBucketNames":[{"Fn::Sub":"cdk-hnb659fds-assets-${AWS::AccountId}-${AWS::Region}"}],"SourceObjectKeys":["9c8ccac4041e3324738cfee0abc38deb70408e182c640f1669d84f7cbace75a6.zip"],"DestinationBucketName":{"Ref":"SiteBucket397A1860"},"WaitForDistributionInvalidation":true,"Prune":true,"DistributionId":{"Ref":"Distribution830FAC52"},"DistributionPaths":["/*"],"OutputObjectKeys":true}` |
